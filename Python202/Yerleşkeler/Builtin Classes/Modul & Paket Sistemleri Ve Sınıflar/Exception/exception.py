...
#   Exception, Python yorumlayıcısının yürütme sırasında oluşan hataları birer yakalanabilir nesne haline getirerek program düzeyine taşıdığı özel yapılardır.
#   Bu sayede hem hatanın kontrolü hem de çıktısı geliştiriciye bırakılır.
...
#
# 5) **Gereksiz Kullanım**:
#    - Exception handling, if yapısına göre çok daha yavaş çalışır bu yavaşlık,istisnanın yakalanıp yakalanmadığına göre değişir
#    - eğer istisna yakalanırsa bu en yavaş çalıştığu durumdur ama hata yoksa kesinlikle daha hızlı çalışır ama bu hız,if yapısına göre bir miktar daha yavaştır
#
# ============================================================
# 📝 ÖZET
# ============================================================
