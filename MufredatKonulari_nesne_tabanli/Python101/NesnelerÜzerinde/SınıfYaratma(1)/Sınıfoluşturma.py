...
"""
class: class,yeni bir şablon oluşturmanı sağlar(yani class -> şablon oluşturucu) 

ClassName: ClassName; burda şablon adıdır, tip tanımıdır, nesneler bu şablondan oluşturulacak ve bu şablonun özelliklerini örnekleme yoluyla taşıyacaklar
