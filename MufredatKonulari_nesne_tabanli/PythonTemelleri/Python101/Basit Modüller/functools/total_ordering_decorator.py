...
class Sepet:
    ...
    def __init__(self,meyve:int= 0):
        self.meyve = meyve

    def __lt__(self, other):
        return self.meyve < other.meyve
    def __eq__(self, other):
        return self.meyve == other.meyve

ayse_sepeti = Sepet(12)
fatma_sepeti = Sepet(15)

print(ayse_sepeti < fatma_sepeti)
print(ayse_sepeti > fatma_sepeti) # Bu otomatik üretildi
print(ayse_sepeti == fatma_sepeti) # Bu vardı
print(ayse_sepeti >= fatma_sepeti) # Bu otomatik üretildi
# total_orering sayesinde sadece 2 metot tanımlayarak tüm sınıfın objeleri tam karşılaştırma yeteneği kazandı
