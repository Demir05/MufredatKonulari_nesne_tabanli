...
# Ancak descriptor değildir (yani __get__ içermez), bu nedenle descriptor çözümlemesi yapılmaz.
...
print(
    v.__class__.__getattribute__(v, "__len__").__get__(v,type(v)).__call__()
)
