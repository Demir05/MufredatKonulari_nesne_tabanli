...
#   -> eğer __iter__ yoksa o zaman fallback mekanizması devreye girer ve __getitem__() ile sırasıyla elemanlar çekilir
...
# ---------------------------------------------------
# 🔹 sorted(list_of_custom_objects): Bu kullanımda da list.__iter__() çalışır yoksa fallback -> __getitem__()
...
# - Eğer X iterable değilse __getitem__() metodu ile fallback mekanizması devreye girer.
