...
#
# 📌 Tanım:
#     Bu eşikten büyük ya da eşit numaralı opcode’ların argüman taşıdığı anlamına gelir.
#     Örn: 90 → LOAD_CONST(100) > 90 olduğu için argümanlıdır (hangi sabit yüklenecek?).
#
# 📌 Amacı:
#     Bytecode çözerken hangi opcode’dan sonra ekstra “2 byte argüman” okuyacağını bilmek.
#
# 📌 Kullanım Alanları:
#     - Kendi disassembler’ını yazarken
#     - co_code çözümlemesinde → argümanlı opcode’ları ayırmak
#     - Eğitim → neden bazı opcode’lar ek veri taşır, bazıları taşımaz anlamak

print(opcode.HAVE_ARGUMENT)  # genelde 90 civarıdır
