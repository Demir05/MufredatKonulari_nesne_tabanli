...
# 🔸 Soyut bir sınıftır; herangi bir davranışı olmadığı için örneklenmesi anlamsızdır.
# 🔸 Tüm node sınıfları bu sınıftan miras alır.
# 🔸 Sınıfın amacı,tüm AST node'larını ortak tek bir ata sınıftan
#   gelmesini sağlamaktır
# 🔸 Ayrıca bu sınıfın,gayesi devranışı genişletmek değildir
# 🔸 tüm AST sınıfları için _fields ve _attributes alanlarını tanımlar.
# Örnek:
...
# 🔸 AST ağacında refactor yapılırken her AST düğümü için alan tahsis edilir
# 🔸 AST geçici olduğu için heap üzerinde kalıcı bir tahsise neden olmaz
#    modern sistemler bunun üstesinden gelebilir
